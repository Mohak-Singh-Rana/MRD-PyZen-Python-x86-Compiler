...
funcdef: DEF func_name parameters COLON suite {
            ...
            $$->offset_map = $3->offset_map;
            $3->offset_map.insert($5->offset_map.begin(), $5->offset_map.end());
        ...
        | DEF func_name parameters ARROW_OPER func_ret_type COLON suite {
            ...
            //m3 start
            $$->stack_width = $3->stack_width + $7->stack_width;
            current_ste->stack_width = $$->stack_width;
            $$->offset_map = $3->offset_map;
            $3->offset_map.insert($7->offset_map.begin(), $7->offset_map.end());
            current_ste->offset_map = $$->offset_map;
            stack_offset = 0;
            //m3 end
        }
        | DEF func_name OPEN_BRACKET CLOSE_BRACKET COLON suite {
            $$ = create_node(7, "funcdef", $1, $2, $3, $4, $5,$6);
            current_ste = get_prev_scope(current_ste);
            ...
            //m3 start
            $$->stack_width = $6->stack_width;
            current_ste->stack_width = $$->stack_width;
            $$->offset_map = $6->offset_map;
            current_ste->offset_map = $$->offset_map;
            stack_offset = 0;
            //m3 end
        }
        | DEF func_name OPEN_BRACKET CLOSE_BRACKET ARROW_OPER func_ret_type COLON suite{
            $$ = create_node(9, "funcdef", $1, $2, $3, $4, $5,$6,$7,$8);
            current_ste = get_prev_scope(current_ste);
            ...
            //m3 start
            $$->stack_width = $8->stack_width;
            current_ste->stack_width = $$->stack_width;
            $$->offset_map = $8->offset_map;
            current_ste->offset_map = $$->offset_map;
            stack_offset = 0;
            //m3 end
        }
...
typedargslist:  typedarg    {  
        ...
        | typedargslist COMMA  typedarg  {  
            ...
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($3->offset_map.begin(), $3->offset_map.end());
            //m3 end
...
tfpdef: NAME {  
        ...
        | NAME COLON TYPE_HINT {  
            ...
            //m3 start 
            $$->stack_width = get_width($3->addr);
            $$->offset_map[chartostring($1->addr)] = stack_offset;
            stack_offset+=get_width($3->addr);
            //m3 end
        }
        ;
...
expr_stmt: test ASSIGN_OPERATOR test { 
            ...
            //m3 start
            $$->stack_width = get_width($1->atom_type) + $1->stack_width + $3->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($3->offset_map.begin(), $3->offset_map.end());
            $$->offset_map[temp] = stack_offset;
            stack_offset+=get_width($1->atom_type);
            //m3end
        }
        | test COLON TYPE_HINT ASSIGN_OPERATOR test { // Is this rule really required?  x:int += 5
            ...
            //M3 START
            $$->stack_width = get_width($3->addr) + get_width($1->atom_type) + $1->stack_width + $5->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($5->offset_map.begin(), $5->offset_map.end());
            $$->offset_map[chartostring($1->addr)] = stack_offset;
            stack_offset+=get_width($3->addr);
            $$->offset_map[temp] = stack_offset;
            stack_offset+=get_width($1->atom_type);
        ...
        | test COLON TYPE_HINT EQUAL eq_testlist_star_expr_plus{
            ...
            //M3 START
            $$->stack_width = get_width($3->addr) + $1->stack_width + $5->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($5->offset_map.begin(), $5->offset_map.end());
            $$->offset_map[chartostring($1->addr)] = stack_offset;
            stack_offset+=get_width($3->addr);
...
if_stmt: if_scope if_expr COLON M suite     {  
        ...
        | if_scope if_expr COLON M suite N else_scope COLON M suite   {  
            ...
            $$->offset_map = $2->offset_map;
            $$->offset_map.insert($5->offset_map.begin(), $5->offset_map.end());
            $$->offset_map.insert($10->offset_map.begin(), $10->offset_map.end());
            //M3 end
        ...
        | if_scope if_expr COLON M suite N nts_star    {  
            ...
            $$->offset_map = $2->offset_map;
            $$->offset_map.insert($5->offset_map.begin(), $5->offset_map.end());
            $$->offset_map.insert($7->offset_map.begin(), $7->offset_map.end());
...
while_stmt: while_scope M while_expr COLON M suite   {  
            ...
            $$->offset_map = $3->offset_map;
            $$->offset_map.insert($6->offset_map.begin(), $6->offset_map.end());
            //M3 end
        }
		| while_scope M while_expr COLON M suite N else_scope COLON M suite  {   
            ...
            $$->offset_map = $3->offset_map;
            $$->offset_map.insert($6->offset_map.begin(), $6->offset_map.end());
            $$->offset_map.insert($11->offset_map.begin(), $11->offset_map.end());
            //m3 end
        }
        ;
...
for_core: expr IN range_stmt   { 
            ...
            //m3 start
            $$->stack_width = get_width("int") + $1->stack_width + $3->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($3->offset_map.begin(), $3->offset_map.end());
            $$->offset_map[temp]=stack_offset;
            stack_offset += get_width("int");
            //m3 end
        }
        ;
...
or_test: and_test    { 
        ...
        | and_test_star OR M and_test    {  
            ...
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($4->offset_map.begin(), $4->offset_map.end());
            //m3 end
        }
        ;
...
shift_expr: arith_expr   { 
            ...
            //m3 start
            $$->stack_width = get_width(ret_type) + $1->stack_width + $3->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($3->offset_map.begin(), $3->offset_map.end());
            $$->offset_map[chartostring($$->addr)]=stack_offset;
            stack_offset += get_width(ret_type);
            //m3 end
            }
        ;
...
factor: factor_choice factor        {  
            ...
            //m3 start
            $$->stack_width = get_width($$->atom_type) + $2->stack_width;
            $$->offset_map = $2->offset_map;
            $$->offset_map[chartostring($$->addr)]=stack_offset;
            stack_offset += get_width($$->atom_type);
            //m3 end
        }
        | power     { 
            $$ = $1;
...
power: atom_expr        { 
        ...
        | atom_expr POWER_OPERATOR factor   { 
            ...
            //m3 start
            $$->atom_type = $1->atom_type;
            $$->stack_width = get_width($$->atom_type) + $1->stack_width + $3->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($3->offset_map.begin(), $3->offset_map.end());
            $$->offset_map[chartostring($$->addr)]=stack_offset;
            stack_offset += get_width($$->atom_type);
...
atom_expr: atom {  
        ...
        | atom_expr trailer {   //this is function call
            ...
            //m3 start
            $$->stack_width = get_width($$->atom_type) + $1->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map.insert($2->offset_map.begin(), $2->offset_map.end());
            $$->offset_map[temp]=stack_offset;
            stack_offset += get_width($$->atom_type);
            //m3 end
...
testlist_list: test         {
        ...
        | test COLON TYPE_HINT{
            ...
            //m3 start
            $$->stack_width = get_width($3->addr) + $1->stack_width;
            $$->offset_map = $1->offset_map;
            $$->offset_map[chartostring($1->addr)] = stack_offset;
            stack_offset += get_width($3->addr);
            //m3 end
